...
import '../../../timeline/transactions/date_picker/presentation/transaction_date_picker.dart';
...
class _UpdateSavingGoalViewState extends ConsumerState<UpdateSavingGoalView> {
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              if (deletePost) {
                await ref
                    .read(deleteSavingGoalProvider.notifier)
                    .deleteSavingGoal(
  ...
  Future<void> _updateSavingGoalController(
    ...
    final isCreated =
        await ref.read(updateSavingGoalProvider.notifier).updateSavingGoal(
