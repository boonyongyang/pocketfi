...
import 'package:pocketfi/src/features/finance/debt/presentation/paid_debt_sheet.dart';
...
class DebtHistoryView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final debtPayments = ref.watch(userPaidDebtsProvider(debt));
    var totalAmountPaid = 0.0;
    var totalInterestPaid = 0.0;

    final debtPaymentsList = ref.watch(userPaidDebtsProvider(debt)).value;
