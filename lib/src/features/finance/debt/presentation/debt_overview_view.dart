...
import 'package:pocketfi/src/features/finance/debt/presentation/debt_data_table.dart';
...
class DebtOverviewView extends ConsumerStatefulWidget {
  ...
  @override
  _DebtOverviewViewState createState() => _DebtOverviewViewState();
}

class _DebtOverviewViewState extends ConsumerState<DebtOverviewView> {
  ...
  //       // minPaymentPerMonth: widget.debt.minimumPayment,
