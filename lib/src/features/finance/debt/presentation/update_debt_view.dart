...
class UpdateDebtView extends StatefulHookConsumerWidget {
  Debt debt;
  UpdateDebtView({
    super.key,
    required this.debt,
...
class _UpdateDebtViewState extends ConsumerState<UpdateDebtView> {
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              if (deletePost) {
                await ref.read(deleteDebtProvider.notifier).deleteDebt(
  ...
  Future<void> _updateDebtController(
    ...
    final isCreated = await ref.read(updateDebtProvider.notifier).updateDebt(
          debtId: debt.debtId,
          userId: debt.userId,
