...
class ShareWalletView extends ConsumerStatefulWidget {
  const ShareWalletView({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ShareWalletViewState();
}

class _ShareWalletViewState extends ConsumerState<ShareWalletView> {
  @override
